...
public class SteelArmorItem extends HgfModElements.ModElement {
	@ObjectHolder("hgf:steel_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("hgf:steel_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("hgf:steel_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("hgf:steel_armor_boots")
	public static final Item boots = null;
	public SteelArmorItem(HgfModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "hgf:textures/models/armor/steel_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
